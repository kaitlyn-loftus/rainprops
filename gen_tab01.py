...
tab01 = pd.DataFrame(tab01_list,columns=['name','z_ref','T(z_ref) [K]','p_dry(z_ref) [Pa]','RH(z_ref) [ ]','g [m/s2]','H_LCL [m]','f_h2 [mol/mol]','f_he [mol/mol]','f_n2 [mol/mol]','f_o2 [mol/mol]','f_co2 [mol/mol]'])
