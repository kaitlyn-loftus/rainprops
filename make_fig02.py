...
axs[1,0].annotate(s='TOTAL \n EVAPORATION',xy=(0.04,0.55),c='k',backgroundcolor='w')
axs[1,0].annotate(s=r'$r_\mathrm{min}$',xy=(0.35,0.27),c='darkviolet',backgroundcolor='w',size=8)
...
axs[0,0].annotate(s='surface RH = 0.75',xy=(0.8,0.85),c='plum',size=8)
axs[0,0].annotate(s=r'$r_\mathrm{min}$',xy=(0.13,0.05),c='darkviolet',size=8)
